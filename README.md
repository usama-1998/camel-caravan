...
- **React 18** — Client Components with `useEffect` / `useRef` for canvas control
- **TypeScript** — Full type safety
- **Canvas 2D API** — High-performance geometric pattern rendering
- **Google Fonts** — Cormorant Garamond, DM Sans, Noto Naskh Arabic
